 ...
 * @author Admin
 */
@WebServlet(name = "ImpReceiptController", urlPatterns = {"/importer/ImpReceiptController"})
public class ImpReceiptController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("impListReceipt.jsp").forward(request, response);
        }
    }
