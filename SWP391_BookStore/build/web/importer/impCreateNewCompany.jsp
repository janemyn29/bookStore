                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide" action="#" method="post">
                                                            <div class="form-group row">
                                                                <label class="col-lg-4 col-form-label" for="val-username">PUBLISH COMPANY ID <span class="text-danger">*</span><br>
                                                                </label>
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Enter a Company ID">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" id="val-uusername" name="val-username" placeholder="Enter a Company Name">
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <table class="table table-striped table-bordered zero-configuration">
                                                                        ...
                                                                        <div class="header-right">
                                                                            <div class="input-group-prepend">
                                                                                <a class="create" href="../importer/impListCompany.jsp">   Create   </a>
                                                                        </div>
