...
<<<<<<< HEAD
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="widget">
                                    ...
                                    <ul class="widget-list">
                                        <li><a href="loginnav">Sign In</a></li>
        ...
        <div class="mobile-menu-container">
            <div class="mobile-menu-wrapper">
                <a href="${pageContext.request.contextPath }/cart?&action=remove&bookCode=${book.bookCode}" class="mobile-menu-close"><i class="icon-close"></i></a>

                <form action="cart" method="post" class="mobile-search">
