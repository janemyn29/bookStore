                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <c:if test='${mess == null}'>
                                                    <input id="phone" type="number" class="form-control" id="register-password-2" name="phone" onkeyup=" return validatephone(this.value); " required>
                                                </c:if>
                                                <c:if test='${mess == "Username alreadly existed!"}'>
                                                    <input id="phone" type="number" class="form-control" id="register-password-2" name="phone" onkeyup=" return validatephone(this.value); " value='${phone}' required>
                                                </c:if>
