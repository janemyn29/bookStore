                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        ...
                                        <c:if test="${cart==null}">
                                            <h4 class="center-parent">Delivery progress</h4>
                                            <div class="container">                                               
                                                <ol class="breadcrumb">
                                                    <div class="dropdown cart-dropdown">
                                                        <li class="btn btn-outline-primary-2"><p>1. Wait For Confirmation</p></li>
                                                        <h5 class="btn-outline">-------></h5>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <div class="dropdown-cart-products">
                                                                <label  style="color: black;">Status:</label><br>
                                                                <label  style="color: black;">Name Seller:</label><br>
                                                                <button  style="color: black;">Cancel Order</button>
                                                            </div>
                                                        </div><!-- End .dropdown-menu -->
                                                    </div>
                                                    <div class="dropdown cart-dropdown">
                                                        <li class="btn btn-outline-primary-2"><p>2. Being transported</p></li>
                                                        <h5 class="btn-outline">-------></h5>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <div class="dropdown-cart-products">
                                                                <label  style="color: black;">Status:</label><br>
                                                                <button  style="color: black;">Cancel Delivery</button>
                                                            </div>
                                                        </div><!-- End .dropdown-menu -->
                                                    </div>
                                                    <div class="dropdown cart-dropdown">
                                                        <li class="btn btn-outline-primary-2"><p>3. Received successfully</p></li>  
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <div class="dropdown-cart-products">
                                                                <label  style="color: black;">Status:</label><br>
                                                                <button  style="color: black;">I have already received</button><br>
                                                                <button  style="color: black;">Doesn't receive any things?</button><br>
                                                                <button href=""  style="color: black;"> Give Feed Back</button>
                                                            </div>
                                                        </div><!-- End .dropdown-menu -->
                                                    </div>
                                                </ol>
