                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="detail?pbookCode=${listAll.bookCode}">
                                                    <img src="${listAll.image}" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="detail?pbookCode=${listAll.bookCode}">${listAll.bookName}</a></h3><!-- End .product-title -->
