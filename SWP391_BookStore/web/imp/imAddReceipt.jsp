    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                var html = '<tr><td><input type="text" name="code"   required></td><td><input type="text"  name="bname"  required></td><td><input type="text" name="qty"  required></td><td><input type="text" name="price"   required></td><td><input type="button" name="remove" value="Remove" id="remove" class="btn btn-danger"></td></tr>';
                var x = 1;
                var add_button = $("#add");
