<%-- 
    Document   : cusViewProfile
    Created on : Sep 26, 2022, 8:26:21 PM
    Author     : Admin
--%>
	                	...
	                	<div class="row">
	                		<aside class="col-md-4 col-lg-3">
	                			<ul class="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
								    <li class="nav-item">
								        <a class="nav-link active" id="tab-dashboard-link" data-toggle="tab" href="" role="tab" aria-controls="tab-dashboard" aria-selected="true">My account</a>
								    </li>
								    <li class="nav-item">
