                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <ul class="compare-products">
                                    <li class="compare-product">
                                        ...
                                        <h4 class="compare-product-title"><a href="product.jsp">Blue Night Dress</a></h4>
                                    </li>
                                    <li class="compare-product">
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                        <h4 class="compare-product-title"><a href="product.jsp">White Long Skirt</a></h4>
                                    </li>
                                </ul>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    ...
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="product.jsp">Blue utility pinafore denim dress</a>
                                            </h4>
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="${detailProduct.image}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-details-footer">
                                        <div class="product-cat">
                                            <span>Category:</span>
                                            <a href="#">${detailProduct.cateName}</a>
                                        </div><!-- End .product-cat -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <h4 class="product-title"><a href="product.jsp">${o.bookName}</a></h4><!-- End .product-title -->
                </div><!-- End .col-6 -->
