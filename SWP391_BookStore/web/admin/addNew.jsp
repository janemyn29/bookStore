                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form">
                                        <c:if test='${role == "seller"}'>
                                            <form action="addnewseller" method="POST" onsubmit="return myfun()">
                                            </c:if>
                                            <c:if test='${role == "importer"}'>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="phone" type="number" name="phone" class="form-control" onkeyup=" return validatephone(this.value); " placeholder="Phone" required>
                                                    </div>
                                                </div>
