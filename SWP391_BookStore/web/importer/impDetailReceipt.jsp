                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        ...
                                        <form class="form-valide" action="#" method="post">
                                                ...
                                                <label class="col-lg-4 col-form-label" for="val-password">RECEIPT ID<span class="text-danger">*</span>                                                    
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="Text" class="form-control" id="val-password" name="val-password" value="${detailReceipt.get(0).receiptID}" readonly>
                                                </div>
                                            </div>
                                           <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="date" class="form-control" id="val-password" name="val-password" value="${detailReceipt.get(0).orderDate}"  readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="Text" class="form-control" id="val-currency" name="val-currency"value="${detailReceipt.get(0).companyName}"  readonly> 
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="Text" class="form-control" id="val-currency" name="val-currency"  value="${detailReceipt.get(0).totalImportPrice} đ "  readonly> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered zero-configuration">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${detailReceipt}" var="rd">
                                                        <tr>
                                                      
                                                            <td>${rd.bookCode}</td>
                                                            <td>${rd.bookName}</td>
                                                            <td>${rd.totalImportPrice} đ</td>
                                                            <td>${rd.quantity} </td>
